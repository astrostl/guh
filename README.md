...
Up to 1000 repos per account or org, newest first. The org picker lists up to 1000 orgs. Unfolding a repo loads every open issue and PR. `c` shows the last 7 commits. `t` opens a shell in `~/src/<repo>` if that directory exists; Ctrl-D returns.
